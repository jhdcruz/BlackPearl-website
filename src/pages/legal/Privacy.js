  ...
  return (
    <>
      <div className="PrivacyPolicy">
        ...
        <Line />
        <p>
          It is BlackPearl in your Area's policy to respect your privacy
        ...
        <p>
          ...
          visitor request. BlackPearl in your Area's purpose in collecting
          non-personally identifying information is to better understand how
          BlackPearl in your Area's visitors use its website. From time to time,
          BlackPearl in your Area may release non-personally-identifying
          information in the aggregate, e.g., by publishing a report on trends
          in the usage of its website.
        </p>
        <p>
          BlackPearl in your Area also collects potentially
          ...
          https://blackpearl.now.sh blog posts. BlackPearl in your Area only
        ...
        <p>
          ...
          interact with BlackPearl in your Area in ways that require BlackPearl
          in your Area to gather personally-identifying information. The amount
          and type of information that BlackPearl in your Area gathers depends
          on the nature of the interaction. For example, we ask visitors who
          sign up for a blog at https://blackpearl.now.sh to provide a username
          and email address.
        </p>
        <h2>Security</h2>
        <p>
        ...
        <p>
          BlackPearl in your Area discloses potentially personally-identifying
          ...
          organizations, as described above, BlackPearl in your Area discloses
          ...
          governmental request, or when BlackPearl in your Area believes in good
          faith that disclosure is reasonably necessary to protect the property
          or rights of BlackPearl in your Area, third parties or the public at
          large.
        </p>
        <p>
          ...
          type of email to a minimum. If you send us a request (for example via
          our feedback mechanism), we reserve the right to publish it in order
          to help us clarify or respond to your request or to help us support
          other users. BlackPearl in your Area takes all measures reasonably
        ...
        <p>
          ...
          website each time the visitor returns. BlackPearl in your Area uses
          cookies to help BlackPearl in your Area identify and track visitors,
          their usage of https://blackpearl.now.sh, and their website access
          preferences. BlackPearl in your Area visitors who do not wish to have
          cookies placed on their computers should set their browsers to refuse
          cookies before using BlackPearl in your Area's websites, with the
          drawback that certain features of BlackPearl in your Area's websites
          may not function properly without the aid of cookies.
        </p>
        <p>
          By continuing to navigate our website without changing your cookie
          settings, you hereby acknowledge and agree to BlackPearl in your
          Area's use of cookies.
        </p>
        ...
        <p>
          ...
          your Area's sole discretion. BlackPearl in your Area encourages
